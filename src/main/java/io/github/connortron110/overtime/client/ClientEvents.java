...
public class ClientEvents {
    ...
    private static void setEntityRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(ModEntities.SCP131.get(), SCP131Renderer::new);
        RenderingRegistry.registerEntityRenderingHandler(ModEntities.SCP303.get(), SCP303Renderer::new);
