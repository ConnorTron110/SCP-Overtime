...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(BlockInit.SCP1025.get().getRegistryName().getPath(), modLoc("block/scp1025"));
        ...
        getBuilder(ItemInit.SCP745_SPAWN_EGG.get().getRegistryName().getPath()).parent(spawnegg);
        ...
        getBuilder(ItemInit.SCP2761_SPAWN_EGG.get().getRegistryName().getPath()).parent(spawnegg);
        ...
        getBuilder(ItemInit.SCP5167_SPAWN_EGG.get().getRegistryName().getPath()).parent(spawnegg);
    }
